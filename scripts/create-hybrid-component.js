...
const baseDir = `src/hybridComponents/${componentName}`;
...
fs.writeFileSync(
  ...
  const meta: Meta<typeof ${componentName}> = {
    ...
    title: 'HybridComponents/${componentName}',
  };
...
console.log(
  `✅ ${componentName} component created in src/hybridComponents/${componentName}`
);
