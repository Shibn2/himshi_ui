...
<rect x="30" y="50" width={`${getRandomNumber(50, 150)}`} height="110" fill="#06d6a0" />
</svg>;

const TriangleSvg = () => {
  const x = getRandomNumber(0, 200);
return <svg viewBox="0 0 200 200">
<path d={`M100,20 L180,${x} L20,180 Z`} fill="#6a4c93" />
</svg>
}
...
<path d={`M100,20 L173,60 L173,140 L100,180 L27,${getRandomNumber(0, 200)} L27,60 Z`} fill="#ffd166" />
</svg>

const OvalSvg = () => <svg viewBox="0 0 200 200">
<ellipse cx="100" cy="50" rx="80" ry="50" fill="#84d9ff" />
</svg>
